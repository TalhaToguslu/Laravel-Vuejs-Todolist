...
Vue.component('wait-component', require('./components/WaitComponent.vue').default);
Vue.component('complete-component', require('./components/CompleteComponent.vue').default);
Vue.component('cancel-component', require('./components/CancelComponent.vue').default);
